...
__C.DATASETS.PASCAL3D.TAXONOMY_FILE_PATH    = '/local-scratch/test/Pix2Vox/datasets/Pascal3D.json'
__C.DATASETS.PASCAL3D.ANNOTATION_PATH       = '/local-scratch/test/Pix2Vox/Datasets/PASCAL3D/Annotations/%s_imagenet/%s.mat'
__C.DATASETS.PASCAL3D.RENDERING_PATH        = '/local-scratch/test/Pix2Vox/Datasets/PASCAL3D/Images/%s_imagenet/%s.JPEG'
__C.DATASETS.PASCAL3D.VOXEL_PATH            = '/local-scratch/test/Pix2Vox/Datasets/PASCAL3D/CAD/%s/%02d.binvox'
__C.DATASETS.PIX3D                          = edict()
__C.DATASETS.PIX3D.TAXONOMY_FILE_PATH       = '/local-scratch/test/Pix2Vox/datasets/Pix3D.json'
__C.DATASETS.PIX3D.ANNOTATION_PATH          = '/local-scratch/test/Pix2Vox/Datasets/Pix3D/pix3d.json'
__C.DATASETS.PIX3D.RENDERING_PATH           = '/local-scratch/test/Pix2Vox/Datasets/Pix3D/img/%s/%s.%s'
__C.DATASETS.PIX3D.VOXEL_PATH               = '/local-scratch/test/Pix2Vox/Datasets/Pix3D/model/%s/%s/%s.binvox'
__C.DATASETS.THINGS3D                       = edict()
__C.DATASETS.THINGS3D.TAXONOMY_FILE_PATH    = '/local-scratch/test/Pix2Vox/datasets/Things3D.json'
__C.DATASETS.THINGS3D.RENDERING_PATH        = '/local-scratch/test/Pix2Vox//Datasets/Things3D/%s/%s/%s/render_%02d_final.png'
__C.DATASETS.THINGS3D.VOXEL_PATH            = '/local-scratch/test/Pix2Vox/Datasets/ShapeNet/ShapeNetVox32/%s/%s.binvox'
...
__C.TRAIN.FC_LEARNING_RATE                  = 1e-3
...
__C.TRAIN.FC_LR_MILESTONES                  = [150]
